...
const CustomCollapse: React.FC<{
    ...
    return (
      <div className={twMerge("transition-all duration-300")}>
        <div
          className={twMerge("flex relative cursor-pointer  items-center justify-between rounded-lg px-6 py-[11px] gap-3 text-15 font-medium text-ld nav-cover",className)}
          onClick={onClick}
        >
