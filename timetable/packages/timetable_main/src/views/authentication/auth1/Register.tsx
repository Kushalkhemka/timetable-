            ...
            <div className="grid grid-cols-12 items-center justify-center">
              ...
              <div className="xl:col-span-6 col-span-12 xl:px-8 px-6">
                <div className="lg:px-6 pb-8">
                  <h3 className="text-3xl font-bold mb-3">Welcome to DTU Faculty</h3>
                  <p className="text-base text-ld">Create your account</p>
                  <SocialButtons title="or sign up with" />
                  <AuthRegister />
                  <div className="flex gap-2 text-sm dark:text-white font-medium mt-6 items-center ">
                    <p>Already have an Account</p>
                    <Link to={'/auth/auth1/login'} className="text-primary text-sm font-medium ">
                      Sign in
                    </Link>
                  </div>
                </div>
