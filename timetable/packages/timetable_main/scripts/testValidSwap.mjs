...
console.log('🔄 Testing valid SWAP_CLASS functionality...\n');

// Test with a valid swap request based on the actual schedule
const testInput = 'Swap the AP101 class on Tuesday P3 with the AP101 class on Tuesday P4 for @BIO_TECHNOLOGY_SEC-1__SEC-1';

console.log(`📋 Testing: Valid SWAP_CLASS request`);
...
try {
  ...
  console.log(`❌ Error testing valid swap:`, error.message);
}

console.log('\n🏁 Valid swap testing completed!');
