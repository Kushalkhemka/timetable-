...
const TeacherDashboard = Loadable(lazy(() => import('../views/dashboard/TeacherDashboard')));
const StudentDashboard = Loadable(lazy(() => import('../views/dashboard/StudentDashboard')));
const StudentProfile = Loadable(lazy(() => import('../views/student/Profile')));
const StudentTTFaculty = Loadable(lazy(() => import('../views/student/timetable/FacultyTT')));
const StudentTTClass = Loadable(lazy(() => import('../views/student/timetable/ClassTT')));
const StudentTTRoom = Loadable(lazy(() => import('../views/student/timetable/RoomTT')));
const StudentTTLab = Loadable(lazy(() => import('../views/student/timetable/LabTT')));
const StudentFindLocation = Loadable(lazy(() => import('../views/student/FindLocation')));
const StudentLeaveApplication = Loadable(lazy(() => import('../views/student/LeaveApplication')));
const StudentEvents = Loadable(lazy(() => import('../views/student/EventsSchedule')));
const StudentNotifications = Loadable(lazy(() => import('../views/student/Notifications')));
const StudentTodos = Loadable(lazy(() => import('../views/student/Todos')));
const StudentStudyMaterial = Loadable(lazy(() => import('../views/student/StudyMaterial')));

/* ****Teacher Pages***** */
const TeacherClasses = Loadable(lazy(() => import('../views/teacher/Classes')));
const TeacherStudents = Loadable(lazy(() => import('../views/teacher/Students')));
const TeacherAssignments = Loadable(lazy(() => import('../views/teacher/Assignments')));
...
const Ecommerce2 = Loadable(lazy(() => import('../views/apps/eCommerce/Ecommerce2')));
const EcommerceDetail = Loadable(lazy(() => import('../views/apps/eCommerce/EcommerceDetail')));
const EcommerceDetailTwo = Loadable(lazy(() => import('../views/apps/eCommerce/EcommerceDetail2')));
...
const UserProfileTwo = Loadable(lazy(() => import('../views/apps/user-profile-two/UserProfile')));
const Teams = Loadable(lazy(() => import('../views/apps/user-profile-two/Teams')));
const Projects = Loadable(lazy(() => import('../views/apps/user-profile-two/Projects')));
const Connections = Loadable(lazy(() => import('../views/apps/user-profile-two/Connections')));
...
const AIModifications = Loadable(lazy(() => import('../views/apps/ai-modifications/AIModifications')));
const Ingest = Loadable(lazy(() => import('../views/apps/curriculum/Ingest')));
const ScenarioSimulation = Loadable(lazy(() => import('../views/apps/scenario/ScenarioSimulation')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/apps/ecommerce/shop2', element: <Ecommerce2 /> },
      ...
      { path: '/apps/ecommerce/detail-two/:id', element: <EcommerceDetailTwo /> },
      ...
      { path: '/apps/ai-modifications', element: <AIModifications /> },
      { path: '/apps/scenario-simulation', element: <ScenarioSimulation /> },
      { path: '/apps/curriculum/ingest', element: <Ingest /> },
  ...
  },
  {
    ...
    children: [
      { path: '/teacher/dashboard', exact: true, element: <TeacherDashboard /> },
      ...
      { path: '/teacher/analytics', element: <TeacherDashboard /> },
      { path: '/teacher/grades', element: <TeacherDashboard /> },
      { path: '/teacher/attendance', element: <TeacherDashboard /> },
      { path: '/teacher/schedule', element: <TeacherDashboard /> },
      { path: '/teacher/lesson-plans', element: <TeacherDashboard /> },
      { path: '/teacher/resources', element: <TeacherDashboard /> },
      { path: '/teacher/quizzes', element: <TeacherDashboard /> },
      { path: '/teacher/course-materials', element: <TeacherDashboard /> },
      { path: '/teacher/messages', element: <TeacherDashboard /> },
      { path: '/teacher/announcements', element: <TeacherDashboard /> },
      { path: '/teacher/parent-communication', element: <TeacherDashboard /> },
      { path: '/teacher/forums', element: <TeacherDashboard /> },
      { path: '/teacher/gradebook', element: <TeacherDashboard /> },
      { path: '/teacher/progress-reports', element: <TeacherDashboard /> },
      { path: '/teacher/performance-analytics', element: <TeacherDashboard /> },
      { path: '/teacher/export-data', element: <TeacherDashboard /> },
      { path: '/teacher/training', element: <TeacherDashboard /> },
      { path: '/teacher/certifications', element: <TeacherDashboard /> },
      { path: '/teacher/collaboration', element: <TeacherDashboard /> },
      { path: '/teacher/feedback', element: <TeacherDashboard /> },
      { path: '/teacher/profile', element: <TeacherDashboard /> },
      { path: '/teacher/settings', element: <TeacherDashboard /> },
      { path: '/teacher/notifications', element: <TeacherDashboard /> },
      { path: '/teacher/help', element: <TeacherDashboard /> },
    ],
  },
  {
    path: '/student',
    ...
    children: [
      { path: '/student/dashboard', exact: true, element: <StudentDashboard /> },
      { path: '/student/profile', element: <StudentProfile /> },
      { path: '/student/timetable/faculty', element: <StudentTTFaculty /> },
      { path: '/student/timetable/class', element: <StudentTTClass /> },
      { path: '/student/timetable/room', element: <StudentTTRoom /> },
      { path: '/student/timetable/lab', element: <StudentTTLab /> },
      { path: '/student/find-location', element: <StudentFindLocation /> },
      { path: '/student/leave-application', element: <StudentLeaveApplication /> },
      { path: '/student/events', element: <StudentEvents /> },
      { path: '/student/notifications', element: <StudentNotifications /> },
      { path: '/student/todos', element: <StudentTodos /> },
      { path: '/student/study-material', element: <StudentStudyMaterial /> },
    ],
  },
];
