      ...
      <div className="mt-10">
        ...
        <div className="flex justify-end gap-3 items-center sm:px-8 mt-6">
          <Button
            ...
            className={`activeTab === 0 ? "active bg-gray-500 " : "bg-gray-500"} rounded-full`}
          >
            Previous
          </Button>
          {activeTab === 0 ? (
            <Button color={"primary"} onClick={() => handleTabClick(1)} className=" rounded-full">
              Next
            </Button>
          ) : null}

          {activeTab === 1 || activeTab == 2 ? (
            <Button color={"primary"} onClick={() => handleTabClick(2)} className=" rounded-full">
