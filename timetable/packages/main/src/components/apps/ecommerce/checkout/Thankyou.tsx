  ...
  return (
    <>
      ...
      <div className="sm:flex justify-between mt-6">
        <Button color={'success'} as={Link} className="sm:mb-0 mb-4 sm:w-fit w-full rounded-full" to="/apps/ecommerce/shop">Continue Shopping</Button>
        <Button color={'primary'} className="sm:mb-0  sm:w-fit  w-full rounded-full">Download Receipt</Button>
      </div>
    </>
  );
};
