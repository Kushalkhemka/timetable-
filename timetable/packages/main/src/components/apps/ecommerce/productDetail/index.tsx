      ...
      {product ? (
        <>
            ...
            <form className="max-w-xs">
              <div className="relative flex items-center ">
                ...
                <input
                  ...
                  className="rounded-s-none! rounded-e-none! text-center h-10 border-x-0! w-fit max-w-12 border-y border-ld !focus:ring-0  focus:border-0 focus:ring-transparent focus:ring-offset-0 bg-transparent"
                  placeholder="0"
                  required
                  value={count}
          ...
          <div className="flex gap-3 flex-wrap items-center mb-6">
            <Button color={"primary"} className="px-8  rounded-full"  onClick={handleAddToCart}>
              Buy now
            </Button>
            <Button color={"error"} className="px-8  rounded-full" onClick={handleAddToCart}>
              Add to Cart
            </Button>
          </div>
