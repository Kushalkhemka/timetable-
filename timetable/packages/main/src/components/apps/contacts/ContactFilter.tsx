        ...
        {filterData.map((filter) => {
          ...
          return (
            <div
              ...
              className={`py-[10px] flex items-center gap-2 px-4 hover:bg-muted dark:hover:bg-lightinfo/60 rounded-md text-ld cursor-pointer ${selectedDepartment === filter.name
                ? "text-primary bg-lighthover dark:bg-lightinfo/60 "
                : ""
                }`}
