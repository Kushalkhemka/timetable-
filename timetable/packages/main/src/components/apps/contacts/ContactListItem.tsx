  ...
  return (
    <>
      <Drawer
        ...
        className="lg:relative lg:translate-none lg:h-auto lg:bg-transparent w-full lg:z-0 dark:bg-dark"
      >
              ...
              {isEditMode && formData ? (
                ...
                <div>
                  ...
                  <div className="py-4 px-5 gap-2 flex">
                    <Button color={"primary"} onClick={handleEditClick} className="">
                      Edit
                    </Button>
                    <Button color={"lighterror"} onClick={handleDeleteClick} className="">
                      Delete
                    </Button>
                  </div>
                </div>
