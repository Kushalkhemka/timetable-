      ...
      <div className="left-part  w-full px-0 ">
        <div className="flex justify-between items-center px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h5 className="text-sm mb-1">Mike Nielsen</h5>
        ...
        <div className="px-6">
          ...
          {/* Sorting */}
          <div className="mb-3">
            <Dropdown label="Recent Chats" className="bg-white text-ld px-0 dark:bg-dark hover:bg-transparent dark:hover:bg-transparent">
