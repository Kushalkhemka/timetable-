      ...
      <SimpleBar className="max-h-[600px] h-[calc(100vh_-_100px)]">
        <div className="border-right border-color-divider h-full">
          {filteredEmails.map((email) => (
            <div
              key={email.id}
              className={`cursor-pointer  py-4 px-6 gap-3 items-center group bg-hover  ${
                selectedEmailId === email.id ? 'bg-lightinfo/30' : ''
              } `}
            >
              <div
              ...
              >
                ...
                <div className="w-full">
                  <div className="flex justify-between">
                    <h6 className="text-sm group-hover:text-primary">{email.from}</h6>
