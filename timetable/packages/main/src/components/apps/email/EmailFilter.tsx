        ...
        <ul className="my-4">
          {filterData.map((item) => {
            ...
            return (
              <li
                key={item.id}
                className={`py-[10px] first:mt-0 mt-1 flex items-center gap-2 px-4 hover:bg-lightinfo dark:hover:bg-lightinfo/30 rounded-md text-ld cursor-pointer capitalize  ${filter === item.name ? "text-primary bg-lightinfo/30" : ""}`}
