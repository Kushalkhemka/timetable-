                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div>
                      <Tooltip content="Delete">
                        <Button
                          aria-label="delete"
                          className="bg-transparent dark:bg-transparent hover:text-primary dark:hover:text-primary h-8 w-8 text-ld p-0 flex items-center hover:bg-transparent dark:hover:bg-transparent"
