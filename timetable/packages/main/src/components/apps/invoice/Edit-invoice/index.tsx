    ...
    <div>
                ...
                <TableRow key={index} className="">
                  ...
                  <TableCell className="whitespace-nowrap">
                    <Tooltip content="Delete Invoice" placement="bottom">
                      <Button
                        color={'lighterror'}
                        className="btn-circle p-0 mb-2 dark:text-error group/link"
                        onClick={() => handleDeleteItem(index)}
                      >
                        <Icon
                          icon="solar:trash-bin-minimalistic-outline"
                          className="group-hover/link:text-white"
                          height={18}
                        />
                      </Button>
                    </Tooltip>
      ...
      {showAlert && (
        <Alert
          color="success"
          rounded
          className="fixed mx-auto start-0 end-0 top-3 w-fit z-9999"
          icon={() => (
            <Icon icon="solar:archive-minimalistic-broken" className="text-white" height={22} />
          )}
        >
          <span className='ms-2'>Invoice data updated successfully.</span>
        </Alert>
      )}
    </div>
  );
