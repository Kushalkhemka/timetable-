...
const PopoverWidthCode = () => {
  ...
  <>
  <div className="mt-4">
    <div className="flex gap-8 bg-lightgray dark:bg-dark py-2 px-4 rounded-sm w-full justify-center">
          <Popover className="relative ">
            <PopoverButton className="block text-sm font-semibold text-ld focus:outline-hidden data-active:text-primary data-hover:text-primary data-focus:outline-1 data-focus:outline-white">Open Popover</PopoverButton>
            <PopoverPanel
            transition
              anchor="bottom"
