          ...
          <TabGroup vertical className="flex gap-3 ">
            <TabList className="flex flex-col gap-3">
              {categories.map(({ name }) => (
                <Tab
                  key={name}
                  className="rounded-md py-2 px-4 text-sm font-semibold text-ld focus:outline-hidden data-selected:bg-primary data-hover:text-white data-selected:text-white data-hover:bg-primary data-selected:data-hover:bg-primary data-focus:outline-1 data-focus:outline-primary"
                >
                  {name}
                </Tab>
              ))}
