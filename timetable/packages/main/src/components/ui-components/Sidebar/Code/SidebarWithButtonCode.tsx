import { IconLayoutDashboard, IconBrandTrello, IconInbox, IconUser } from '@tabler/icons-react';
import {
  Sidebar,
  Badge,
  SidebarCTA,
        ...
        <Sidebar aria-label="Sidebar with call to action button example">
          ...
          <SidebarCTA>
            ...
            <div className="mb-3 text-sm text-cyan-900 dark:text-gray-400">
              Preview the new Flowbite dashboard navigation! You can turn the new navigation off for
              a limited time in your profile.
            </div>
            <a
