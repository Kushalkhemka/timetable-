...
const AlertWithIconCode = () => {
  return (
    <div className="flex flex-col gap-2">
      <Alert color="primary" icon={HiInformationCircle} className="rounded-md">
        <span className="font-medium">Primary</span> - A simple primary alert
      </Alert>

      <Alert color="secondary" icon={HiInformationCircle} className="rounded-md">
        <span className="font-medium">Secondary</span> - A simple secondary alert
      </Alert>

      <Alert color="success" icon={HiInformationCircle} className="rounded-md">
      ...
      <Alert color="warning" icon={HiInformationCircle} className="rounded-md">
