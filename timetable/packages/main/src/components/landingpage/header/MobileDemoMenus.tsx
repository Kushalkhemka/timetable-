            ...
            <div className="p-0">
              ...
              <div className="grid xl:grid-cols-5 grid-cols-1 gap-6">
                {FrontMenu.map((item, index) => (
                  <div key={index}>
                    <div className="overflow-hidden border border-ld rounded-md relative flex justify-center items-center group ">
                      <img src={item.img} alt="Spike" className="w-full" />
                      {item.link != "" ? (
                        <>
                          <Button
                            as={Link}
        ...
        <AccordionPanel>
          ...
          <AccordionContent className="px-0 py-3">
            <div className="grid grid-cols-12 w-full">
              <div className="xl:col-span-8 col-span-12 flex items-stretch xl:px-5 xl:pr-0 px-0 py-5">
                <div className="grid grid-cols-12 xl:gap-3 w-full">
