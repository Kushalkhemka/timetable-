...
import imgfirebase from "/src/assets/images/landingpage/demos/demo-firebase.jpg";
...
const Demos: DemoTypes[] = [
  {
    ...
    img: img1,
    name: "Main",
    link: "https://spike-react-tailwind-main.netlify.app/",
    include: "Demo",
  },
  {
    type: true,
  ...
  },
  {
    ...
    img: img3,
    name: "Horizontal",
    link: "https://spike-react-tailwind-horizontal.netlify.app",
    include: "Demo",
  },
  {
    type: true,
    img: img4,
    name: "Minisidebar",
    link: "https://spike-react-tailwind-minisidebar.netlify.app/",
    include: "Demo",
  },
  {
    type: true,
...

  {
    ...
    img: imgfirebase,
    name: "Firebase",
    link: "https://spike-react-tailwind-firebase.netlify.app",
    include: "Demo",
  },
  ...
  },
  {
    ...
    link: "/apps/user-profile/profiletwo",
    include: "Application",
  },
  {
    type: false,
  ...
  },
  {
    ...
    link: "/apps/ecommerce/detail-two/5",
    include: "Application",
  },
  {
    type: false,
...
const listFeature: ListFeatureTypes[] = [
  {
    ...
    subtitle: "Spike Admin comes with 6 pre-defined theme colors.",
    bgcolor: "primary",
  },
  {
    featureicon: IconDiamond,
    title: "3400+ Font Icons",
    subtitle: "The Spike Admin package includes numerous icon fonts.",
    bgcolor: "success",
  },
  {
  ...
  },
  {
    ...
    subtitle: "The Spike Admin Pack includes nearly 45 UI components.",
    bgcolor: "success",
  },
  {
  ...
  },
  {
    ...
    title: "SWR",
    subtitle:
      "SWR is a powerful React library for data fetching, designed to simplify state management.",
    bgcolor: "secondary",
  },
  {
...

  {
    ...
    subtitle:"We created comprehensive documentation to make usage straightforward.",
    bgcolor: "secondary",
  },
