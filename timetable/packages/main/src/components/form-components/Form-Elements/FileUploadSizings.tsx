...
<div>
  <CardBox>
    ...
    <div>
      <div className="my-5">
        <Label htmlFor="small-file-upload"  className="block mb-2">Small file input</Label>
        <FileInput id="small-file-upload" sizing="sm" className="form-control" />
      </div>
      <div className="mb-5">
        <Label htmlFor="default-file-upload"  className="block mb-2">Default size file input</Label>
        <FileInput id="default-file-upload" className="form-control" />
      </div>
      <div>
        <Label htmlFor="large-file-upload "  className="block mb-2">Large file input</Label>
