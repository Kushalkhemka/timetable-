...
<div>
  <CardBox>
    ...
    <form className="flex max-w-md flex-col gap-4">
      <div>
        <Label htmlFor="email2"  className="block mb-2">Your email</Label>
        <TextInput
          id="email2"
          type="email"
      ...
      <div>
        <Label htmlFor="password2"  className="block mb-2">Your password</Label>
        <TextInput
          id="password2"
          type="password"
          required
      ...
      <div>
        <Label htmlFor="repeat-password"  className="block mb-2">Repeat password</Label>
        <TextInput
          id="repeat-password"
          type="password"
          required
