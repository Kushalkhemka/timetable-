...
<div>
  <CardBox>
    ...
    <div className="flex max-w-md flex-col gap-4">
      <div>
        <Label htmlFor="small"  className="block mb-2">Small input</Label>
        <TextInput id="small" type="text" sizing="sm" className="form-control" />
      </div>
      <div>
        <Label htmlFor="base"  className="block mb-2">Base input</Label>
        <TextInput id="base" type="text" sizing="md" className="form-control" />
      </div>
      <div>
        <Label htmlFor="large"  className="block mb-2">Large input</Label>
