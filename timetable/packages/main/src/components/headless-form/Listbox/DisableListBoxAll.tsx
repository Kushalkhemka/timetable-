  ...
  return (
    <div>
      <CardBox>
        ...
        <Field className=" max-w-sm flex gap-3 items-center w-full" disabled>
          <Listbox value={selectedPerson} onChange={setSelectedPerson}>
            <ListboxButton className="ui-button bg-slate-500 justify-between items-center gap-3 w-fit">
              {selectedPerson.name}{" "}
