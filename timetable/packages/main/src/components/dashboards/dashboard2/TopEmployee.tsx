    ...
    <>
      <CardBox>
        <div className="flex justify-between align-baseline">
          <h5 className="card-title">Top Employees</h5>
          <div>
            <Dropdown
              label=""
        ...
        <div className="overflow-x-auto overflow-y-hidden">
          <Table className="">
            <TableHead className=''>
              <TableHeadCell className="text-15 font-semibold  py-3 whitespace-nowrap">Profile</TableHeadCell>
              <TableHeadCell className="text-15 font-semibold  py-3 whitespace-nowrap">Hour Rate</TableHeadCell>
              <TableHeadCell className="text-15 font-semibold py-3 whitespace-nowrap">Skills</TableHeadCell>
              <TableHeadCell className="text-15 font-semibold py-3 whitespace-nowrap">Status</TableHeadCell>
