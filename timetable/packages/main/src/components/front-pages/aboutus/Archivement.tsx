            ...
            <div className="xl:col-span-7 col-span-12">
              <div className="flex flex-wrap lg:gap-8 gap-6">
                <div>
                  ...
                  <span className="text-sm text-dark opacity-90">When we founded Spike</span>
                </div>
                <div>
                  <h3 className="text-primary lg:text-64 text-5xl leading-tight font-normal">300k+</h3>
                  <span className="text-sm text-dark opacity-90">Customers on Spike</span>
                </div>
                <div>
