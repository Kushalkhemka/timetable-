    ...
    <>
      <div className="dark:bg-dark">
        <div className="container mx-auto lg:py-24 py-12">
          ...
          <div className="grid grid-cols-12 md:gap-6 gap-6">
            {Feature.map((item, index) => (
              ...
              >
                <div className={`${item.bgcolor} p-6 rounded-lg`}>
                  <div
                    className={`h-12 w-12 shrink-0 flex items-center justify-center rounded-lg bg-white dark:bg-darkgray shadow-elevation4`}
                  >
                    <Icon
                      icon={item.icon}
                  ...
                  <p className="text-15 font-medium  leading-6">
                    {item.subtitle}
                  </p>
                </div>
              </div>
