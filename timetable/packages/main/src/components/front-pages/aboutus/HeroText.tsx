  ...
  return (
    <>
      <div className="bg-lightprimary/40">
        <div className="container mx-auto md:py-14 py-7">
          <div className="grid grid-cols-12 gap-6">
            <div className="lg:col-span-6 col-span-12 lg:text-start text-center">
              ...
              <div className="sm:flex lg:justify-start justify-center gap-5 py-6">
                <Button
                  ...
                  className="px-6 sm:w-fit w-full"
                >
                  Create an Account
                </Button>
                <Button
                  ...
                  as={Link}
                  to="/"
                  className="px-6 sm:w-fit w-full sm:mt-0 mt-4"
                >
                  View Open Positions
                </Button>
              </div>
            ...
            <div className="lg:col-span-6 col-span-12 lg:text-left text-center">
                <p className="text-base text-ld opacity-90 leading-8 xl:ps-20 pt-4">Do you need a highly customizable and developer friendly premium Reactjs admin template packed with numerous features? <b className="opacity-100">Spike Reactjs Admin</b> template has everything you need. This Reactjs based admin template is designed in accordance with industry standards and best practices to provide you.</p>
            </div>
          </div>
        </div>
      </div>
