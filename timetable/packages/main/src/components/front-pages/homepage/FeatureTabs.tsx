        ...
        <div className="container mx-auto">
          ...
          <div className="overflow-x-auto ">
            <div className="flex shrink-0 gap-4 md:pb-14 pb-8">
              <div
                ...
                className={` py-4 px-6 whitespace-nowrap w-full rounded-lg cursor-pointer text-dark text-base font-semibold text-center flex gap-2 justify-center items-center  md:hover:bg-lightprimary md:dark:hover:bg-lightprimary md:hover:text-primary shadow-elevation2 ${
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-6 col-span-12">
              <img src={mainbanner} className="w-full rounded-lg" alt="banner" />
            </div>
            <div className="lg:col-span-6 col-span-12 lg:ps-7">
                  ...
                  <Accordion className="shadow-none dark:shadow-none divide-y-0 rounded-none!">
                    {Tab1.map((item, i) => (
                      ...
                      >
                        <AccordionTitle className="focus:ring-0 px-3 text-17 font-semibold text-ld py-5 !hover:bg-transparent !dark:hover:bg-transparent !dark:bg-transparent">
                          {item.title}
                        </AccordionTitle>
                        <AccordionContent className="px-3 pt-3 rounded-none!">
                  ...
                  <Accordion className="shadow-none dark:shadow-none divide-y-0 rounded-none!">
                    {Tab4.map((item, i) => (
                      ...
                      >
                        ...
                        <AccordionContent className="px-3 pt-3 rounded-none! bg-transparent">
                          <p className="text-base text-darklink leading-7 ">
                            {item.desc}
                          </p>
                        </AccordionContent>
