    ...
    <>
      <div className="dark:bg-dark">
        <div className="max-w-[800px] mx-auto px-5 lg:py-24 py-12">
          ...
          <Accordion className="shadow-none dark:shadow-none rounded-none! flex flex-col gap-4">
              ...
              return (
                  ...
                  <AccordionPanel key={index}>
                    ...
                    <AccordionContent className="p-0! px-0 pt-0 rounded-none">
                      <p className="text-base text-darklink leading-7 border border-t-0 border-border dark:border-darkborder -mt-5 px-6 py-5 rounded-b-md">
                        {item.answer}
                      </p>
                    </AccordionContent>
                  </AccordionPanel>
          ...
          <p className="mt-14 text-sm font-medium justify-center text-darklink flex flex-wrap items-center gap-1 border border-ld border-dashed w-fit mx-auto px-3 py-1.5 rounded-md">
