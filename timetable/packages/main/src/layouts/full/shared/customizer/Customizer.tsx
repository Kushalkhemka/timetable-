          ...
          <div className="p-4">
            ...
            <div className="flex gap-4 mb-7">
              <Button
                color={'primary'}
                size="xl"
                className={`border bg-transparent text-sm text-darklink btn-shadow border-ld  dark:text-white hover:bg-lightprimary hover:text-primary dark:hover:text-primary rounded-md py-3 px-6  
                ${
                  activeMode === 'light'
                    ? 'active text-primary bg-lightprimary dark:text-primary border-none'
                    : ''
                }`}
                onClick={() => {
                  setActiveMode('light');
              ...
              <Button
                color={'primary'}
                size="xl"
                className={`border bg-transparent text-sm dark:text-white border-ld text-darklink hover:bg-lightprimary hover:text-primary dark:hover:text-primary rounded-md py-3 px-6 ${
                  activeMode === 'dark'
                    ? 'active text-primary bg-lightprimary dark:text-primary border-none'
                    : ''
                }`}
            ...
            <div className="flex gap-4 mb-7">
              <Button
                color={'primary'}
                size="xl"
                className={`border bg-transparent text-sm text-darklink dark:text-white border-ld  hover:bg-lightprimary hover:text-primary dark:hover:text-primary rounded-md py-3 px-6   ${
                  activeDir === 'ltr'
                    ? 'text-primary bg-lightprimary dark:text-primary border-none'
                    : ''
                }`}
                onClick={() => {
                  setActiveDir('ltr');
              ...
              <Button
                color={'primary'}
                size="xl"
                className={`border bg-transparent text-sm btn-shadow border-ld text-darklink dark:text-white hover:bg-lightprimary hover:text-primary dark:hover:text-primary rounded-md py-3 px-6 ${
                  activeDir === 'rtl'
                    ? 'text-primary bg-lightprimary dark:text-primary border-none'
                    : ''
                }`}
            ...
            <div className="flex flex-row flex-wrap  gap-4 mb-7">
              {themeColors.map((theme, index) => (
                <span
                  ...
                  className="border bg-transparent text-sm text-link dark:text-white border-ld py-5 px-6 rounded-md cursor-pointer "
                >
                  <Tooltip content={theme.disp} placement="top" animation="duration-500">
                    ...
                    >
                      {activeTheme === theme.disp && <IconCheck className="text-white" size={18} />}
                    </label>
                  </Tooltip>
                </span>
              ))}
            ...
            <div className="flex flex-wrap  gap-4 mb-7">
              <Button
                ...
                size="xl"
                className={`border bg-transparent text-sm btn-shadow border-ld text-darklink dark:text-white hover:bg-lightprimary hover:text-primary dark:hover:text-primary rounded-md py-3 px-6  ${
                  !isCardShadow ? 'text-primary bg-lightprimary dark:text-primary border-none' : ''
                }`}
