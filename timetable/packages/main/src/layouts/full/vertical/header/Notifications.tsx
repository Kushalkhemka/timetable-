      ...
      <Dropdown
        ...
        renderTrigger={() => (
          <div className="relative">
            <span className="h-10 w-10 hover:bg-lightprimary rounded-full flex justify-center items-center cursor-pointer group-hover/menu:bg-lightprimary group-hover/menu:text-primary text-link dark:text-white">
      ...
      >
        ...
        <div className="pt-5 px-6">
          <Button
            ...
            outline
            as={Link}
            to={'/apps/user-profile/connections'}
          >
