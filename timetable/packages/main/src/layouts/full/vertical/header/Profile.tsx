      ...
      <Dropdown
        ...
        renderTrigger={() => (
          <div className="flex items-center gap-3">
            <span className="relative md:h-10 md:w-10 h-9 w-9 hover:text-primary hover:bg-lightprimary rounded-full flex justify-center items-center  group-hover/menu:bg-lightprimary group-hover/menu:text-primary">
              <img src={user1} alt="logo" height="50" width="50" className="rounded-full" />
               <span className="absolute -top-1 -end-1 h-4 w-4 rounded-full bg-success flex items-center justify-center text-white border-2 border-white">
      ...
      >
        <div className="px-6">
          ...
          <div className="flex items-center gap-6 pb-5 border-b border-ld mt-5 mb-3">
            ...
            <div >
              <h5 className="card-title">Mike Nielsen</h5>
              <span className="text-darklink">Admin</span>
