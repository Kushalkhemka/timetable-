...
const customTheme = createTheme(
  {
    ...
    checkbox: {
      base: "rounded border-2 flex cursor-pointer w-[18px] h-[18px] bg-transparent dark:bg-transparent focus:shadow-none focus:ring-0 focus:outline-none focus:ring-offset-0",
      color: {
   ...
   star: {
    ...
    accordion: {
      root: {
        base: "divide-y divide-transparent dark:divide-transparent border-transparent  dark:border-transparent hover:bg-transaprent dark:hover:bg-transaprent focus:ring-0 ",
        flush: {
      ...
      content: {
        base: "p-5 first:rounded-t-lg last:rounded-b-lg text-sm text-darklink !bg-transparent ",
      },
      title: {
        arrow: {
          base: "h-6 w-6 shrink-0 dark:bg-transparent ",
          open: {
            off: "",
            on: "rotate-180",
          },
        },
        base: "flex text-base w-full cursor-pointer items-center justify-between p-5 text-start ",
        flush: {
          off: " focus:ring-0 ",
        ...
        heading: "",
        open: {
          off: "hover:bg-lightprimary dark:hover:bg-lightprimary",
          on: "bg-lightprimary/50 dark:bg-lightprimary/30 hover:bg-lightprimary dark:hover:bg-lightprimary dark:text-white",
        },
      },
    },
    ...
    tabs: {
      ...
      tablist: {
        ...
        variant: {
          default: "flex-wrap border-b border-ld dark:border-gray-700 cursor-pointer",
        ...
        tabitem: {
          base: "flex items-center cursor-pointer gap-2 justify-center rounded-t-lg p-4 text-sm  first:ml-0 focus:outline-hidden focus:ring-0 disabled:cursor-not-allowed disabled:text-gray-400 dark:disabled:text-gray-500",
          variant: {
            default: {
              base: "rounded-t-lg",
              active: {
                on: "bg-lightprimary dark:bg-lightprimary text-primary ",
            ...
            underline: {
              ...
              active: {
                ...
                off: "border-b-2 border-transparent text-gray-500 hover:border-primary hover:text-primary dark:text-gray-400 dark:hover:text-primary",
              },
            },
            pills: {
              base: "rounded-t-lg",
            ...
            fullWidth: {
              ...
              active: {
                on: " rounded-t-lg bg-lightprimary p-4 text-primary dark:bg-lightprimary dark:text-primary",
                off: "bg-white rounded-t-lg dark:bg-transparent hover:bg-lightprimary hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white ",
              },
            },
          },
          icon: "mr-2 h-5 w-5",
    ...
    toast: {
     ...
     closed : "opacity-0 ease-out cursor-pointer"
  },
  toggle: {
    ...
    carousel: {
      ...
      indicators: {
        ...
        base: "h-3 w-3 rounded-full cursor-pointer",
        wrapper: "absolute bottom-3 left-1/2 flex -translate-x-1/2 space-x-3",
      },
  
      control: {
        base: "inline-flex sm:h-10 sm:w-10 h-0 w-0 items-center justify-center rounded-full bg-muted hover:bg-primary hover:text-white  group-hover:bg-primary group-focus:outline-hidden group-focus:ring-0 cursor-pointer",
        icon: " h-0 w-0 text-dark sm:h-4 sm:w-4 hover:text-white ",
      },
    },
    ...
    toggleSwitch: {
      ...
      toggle: {
        ...
        checked: {
          ...
          color: {
            "default": "bg-primary border-primary group-focus:ring-primary-300 dark:group-focus:ring-primary",
    ...
    hr: {
      ...
      text: {
        ...
        text: "absolute left-1/2 -translate-x-1/2 bg-white px-3 text-sm font-medium text-link/50 dark:bg-darkgray dark:text-white",
      },
    },
    ...
    listGroup: {
      root: {
        base: "list-none rounded-lg border border-gray-200 bg-white text-left text-sm font-medium text-gray-900 dark:border-gray-600 dark:bg-gray-700 overflow-hidden dark:text-white",
      },
      item: {
        base: "[&>*]:first:rounded-t-lg [&>*]:last:rounded-b-lg [&>*]:last:border-b ",
        link: {
          base: "flex w-full items-center border-b border-gray-200 px-4 py-2 dark:border-gray-600 !rounded-none cursor-pointer hover:bg-lighthover dark:hover:bg-darkmuted",
          active: {
            ...
            on: "bg-cyan-700 text-white  dark:bg-primary",
          },
          disabled: {
            off: "",
