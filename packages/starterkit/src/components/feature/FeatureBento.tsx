...
const features: Feature[] = [
  ...
  { id: '03', label: 'Substitution', sublabel: 'Manage Faculty substitutions', icon: <Shuffle className="h-5 w-5" /> },
  { id: '04', label: 'Leave Management', sublabel: 'Requests & approvals', icon: <FileCheck2 className="h-5 w-5" /> },
  { id: '05', label: 'View Schedule', sublabel: 'Watch Dynamic Schedule', icon: <Clock className="h-5 w-5" /> },
  { id: '06', label: 'Ingest Curriculum', sublabel: 'Smart Curriculum Centered Distribution', icon: <BookPlus className="h-5 w-5" /> },
  { id: '07', label: 'NLP Based Modifications', sublabel: 'Smart Edits', variant: 'accent', icon: <Wand2 className="h-5 w-5" /> },
  { id: '08', label: 'Faculty Management', sublabel: 'Add/Remove Instructors', icon: <Users className="h-5 w-5" /> },
];
